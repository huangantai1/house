...
<DIV id=logo>欢迎：${sessionScope.loginInfo.name}<IMG src="../images/logo.gif"></DIV>
<DIV class=search><LABEL class="ui-green searchs"><a href="goFaBu" title="">发布房屋信息</a></LABEL>
...
<TABLE class=house-list>
  ...
  <TR>
    <TD class=house-thumb><SPAN><A href="details.htm" target="_blank"><img src="http://localhost:80/${h.path}" height="75" alt=""></A></SPAN></TD>
    <TD>
      <DL>
    ...
    <TD class=house-price><LABEL class=ui-green><INPUT onclick="location.href='delHouse?id=${h.id}'" value="删    除" type=button name=search></LABEL></TD></TR></c:forEach>
  </TBODY></TABLE></DIV>
<DIV class=pager>
<UL>

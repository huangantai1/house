...
function openShowSteetDialog(id) {
	$("#showStreetDialog").dialog("open").dialog("setTitle","街道信息");
    $('#div1').datagrid({
        title:"街道信息",
...
function upDaveDialog() {
	$("#upDialogForm").form('submit',{url:"updateDistrict",success:function(data){
		data=$.parseJSON(data);
		if(data==1){
